...
from spatio.configuration import Configuration
from spatio.api_response import ApiResponse, T as ApiResponseT
import spatio.models
from spatio import rest
from spatio.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(spatio.models, klass)
