...
class NavigationApi:
    ...
    def get_navigation(
        ...
        _param = self._get_navigation_serialize(
    ...
    @validate_call
    def get_navigation_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_navigation_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
