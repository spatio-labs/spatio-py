...
class ChatMessage(BaseModel):
    ...
    text: StrictStr
    thread_id: Optional[StrictStr] = Field(default=None, description="Set on replies and on parent messages once a thread exists. ", alias="threadId")
    timestamp: datetime
    reply_count: Optional[StrictInt] = Field(default=None, alias="replyCount")
    extra: Optional[Dict[str, Any]] = Field(default=None, description="Provider-specific extras.")
    __properties: ClassVar[List[str]] = ["id", "provider", "accountId", "channelId", "userId", "text", "threadId", "timestamp", "replyCount", "extra"]
