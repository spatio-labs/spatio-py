...
class IssueCollaborationTokenRequest(BaseModel):
    """
    IssueCollaborationTokenRequest
    """ # noqa: E501
    room: Optional[StrictStr] = Field(default=None, description="Optional `<type>:<id>` room identifier (e.g. `note:abc123`). When set, the JWT only authorizes this single room. ")
    __properties: ClassVar[List[str]] = ["room"]
