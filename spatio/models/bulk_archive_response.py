...
class BulkArchiveResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool = Field(description="`true` only when zero rows in `failed`.")
    archived: List[StrictStr]
    failed: List[BulkArchiveResponseFailedInner]
    __properties: ClassVar[List[str]] = ["success", "archived", "failed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [BulkArchiveResponseFailedInner.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
