...
class ClientRegistrationRequest(BaseModel):
    ...
    redirect_uris: Annotated[List[StrictStr], Field(max_length=10)]
    grant_types: Optional[List[StrictStr]] = None
    response_types: Optional[List[StrictStr]] = None
    scope: Optional[StrictStr] = Field(default=None, description="Space-separated scope list. Defaults to `read:*`.")
    ...
    __properties: ClassVar[List[str]] = ["client_name", "redirect_uris", "grant_types", "response_types", "scope", "token_endpoint_auth_method", "client_uri", "logo_uri", "policy_uri", "tos_uri"]
    ...
    def token_endpoint_auth_method_validate_enum(cls, value):
        ...
        if value not in set(['none', 'client_secret_basic', 'client_secret_post']):
            raise ValueError("must be one of enum values ('none', 'client_secret_basic', 'client_secret_post')")
        return value
