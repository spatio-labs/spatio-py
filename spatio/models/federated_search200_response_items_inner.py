...
class FederatedSearch200ResponseItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "entity_type", "platform", "provider_id", "title", "description", "snippet", "author", "created_at", "updated_at", "score"]
