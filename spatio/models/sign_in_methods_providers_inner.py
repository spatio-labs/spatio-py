...
class SignInMethodsProvidersInner(BaseModel):
    """
    SignInMethodsProvidersInner
    """ # noqa: E501
    provider: StrictStr = Field(description="OAuth IdP: `GOOGLE`, `GITHUB`, etc.")
    account_email: Optional[StrictStr] = Field(default=None, alias="accountEmail")
    ...
    __properties: ClassVar[List[str]] = ["provider", "accountEmail", "linkedAt", "lastUsedAt"]
