...
class SlideElementList(BaseModel):
    """
    SlideElementList
    """ # noqa: E501
    elements: List[SlideElement]
    total: StrictInt
    __properties: ClassVar[List[str]] = ["elements", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [SlideElement.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None,
            "total": obj.get("total")
        })
        return _obj
