...
class DMMuteRequest(BaseModel):
    """
    Mute either until a specific time (`untilSeconds`, Unix epoch) or forever (`forever: true`). At least one must be set. 
    """ # noqa: E501
    until_seconds: Optional[StrictInt] = Field(default=None, alias="untilSeconds")
    forever: Optional[StrictBool] = None
    account_id: Optional[StrictStr] = Field(default=None, alias="accountId")
    __properties: ClassVar[List[str]] = ["untilSeconds", "forever", "accountId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "untilSeconds": obj.get("untilSeconds"),
            "forever": obj.get("forever"),
