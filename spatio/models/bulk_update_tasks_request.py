...
class BulkUpdateTasksRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["taskIds", "accountIds", "accountId", "updates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": UpdateTaskRequest.from_dict(obj["updates"]) if obj.get("updates") is not None else None
        })
        return _obj
