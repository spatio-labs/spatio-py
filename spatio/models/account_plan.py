...
class AccountPlan(BaseModel):
    ...
    subscription_status: StrictStr = Field(description="Stripe subscription state: `ACTIVE`, `TRIALING`, `PAST_DUE`, `CANCELED`, etc.")
    trial_ends_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["tier", "display_name", "subscription_status", "trial_ends_at"]
