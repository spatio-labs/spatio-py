...
class CallListResponse(BaseModel):
    ...
    CallListResponse
    """ # noqa: E501
    calls: Optional[List[SpatioCall]]
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["calls", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calls": [SpatioCall.from_dict(_item) for _item in obj["calls"]] if obj.get("calls") is not None else None,
            "total": obj.get("total")
        })
        return _obj
