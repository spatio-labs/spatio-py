...
class BulkDeleteFilesRequest(BaseModel):
    ...
    account_ids: Optional[List[StrictStr]] = Field(default=None, description="Parallel slice with fileIds — accountIds[i] targets fileIds[i].", alias="accountIds")
    ...
    __properties: ClassVar[List[str]] = ["fileIds", "accountIds", "fileId", "accountId"]
