...
class ListChannelsResponse(BaseModel):
    ...
    """ # noqa: E501
    channels: Optional[List[Channel]] = Field(default=None, description="`null` when no results (Go nil-slice serialization).")
    total: StrictInt
    next_cursor: Optional[StrictStr] = Field(default=None, alias="nextCursor")
    provider: StrictStr
    __properties: ClassVar[List[str]] = ["channels", "total", "nextCursor", "provider"]
