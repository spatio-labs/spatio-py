...
class RoutineRun(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    routine_id: Optional[StrictStr] = Field(default=None, alias="routineId")
    status: Optional[StrictStr] = None
    progress: Optional[StrictInt] = None
    metadata: Optional[Dict[str, Any]] = None
    started_at: Optional[datetime] = Field(default=None, alias="startedAt")
    completed_at: Optional[datetime] = Field(default=None, alias="completedAt")
    __properties: ClassVar[List[str]] = ["id", "routineId", "status", "progress", "metadata", "startedAt", "completedAt"]
