...
class UpdateEmailRequest(BaseModel):
    ...
    add_labels: Optional[List[StrictStr]] = Field(default=None, alias="addLabels")
    remove_labels: Optional[List[StrictStr]] = Field(default=None, alias="removeLabels")
    __properties: ClassVar[List[str]] = ["accountId", "isRead", "isStarred", "addLabels", "removeLabels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addLabels": obj.get("addLabels"),
            "removeLabels": obj.get("removeLabels")
        })
        return _obj
