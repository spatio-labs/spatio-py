...
class BulkDeleteTasksRequest(BaseModel):
    ...
    account_ids: Optional[List[StrictStr]] = Field(default=None, description="Parallel slice with taskIds — accountIds[i] targets taskIds[i].", alias="accountIds")
    task_id: Optional[StrictStr] = Field(default=None, description="Singular fallback when only deleting one task.", alias="taskId")
    account_id: Optional[StrictStr] = Field(default=None, alias="accountId")
    __properties: ClassVar[List[str]] = ["taskIds", "accountIds", "taskId", "accountId"]
