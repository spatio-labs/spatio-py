...
class ClientRegistrationResponse(BaseModel):
    ...
    """ # noqa: E501
    client_id: StrictStr
    client_secret: Optional[StrictStr] = Field(default=None, description="Only returned when token_endpoint_auth_method is client_secret_*.")
    ...
    registration_access_token: StrictStr
    registration_client_uri: Optional[StrictStr] = None
    client_id_issued_at: StrictInt
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "client_name", "redirect_uris", "grant_types", "response_types", "scope", "token_endpoint_auth_method", "registration_access_token", "registration_client_uri", "client_id_issued_at"]
