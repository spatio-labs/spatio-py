...
class AccountListResponse(BaseModel):
    ...
    """ # noqa: E501
    accounts_by_platform: Optional[Dict[str, Any]] = None
    total_accounts: Optional[StrictInt] = None
    accounts: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["accounts_by_platform", "total_accounts", "accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts_by_platform": obj.get("accounts_by_platform"),
