...
class CreateSheetRequest(BaseModel):
    ...
    column_count: Optional[StrictInt] = Field(default=None, alias="columnCount")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "data", "rowCount", "columnCount", "accountId", "provider"]
