...
class WorkspaceMember(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "role", "email", "name", "avatar", "joinedAt", "user"]

    @field_validator('role')
    def role_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['owner', 'admin', 'member', 'guest']):
            raise ValueError("must be one of enum values ('owner', 'admin', 'member', 'guest')")
        return value
