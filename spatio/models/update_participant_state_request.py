...
class UpdateParticipantStateRequest(BaseModel):
    """
    Toggle audio/video/screen-share state.
    """ # noqa: E501
    audio_enabled: Optional[StrictBool] = Field(default=None, alias="audioEnabled")
    video_enabled: Optional[StrictBool] = Field(default=None, alias="videoEnabled")
    screen_share_enabled: Optional[StrictBool] = Field(default=None, alias="screenShareEnabled")
    __properties: ClassVar[List[str]] = ["audioEnabled", "videoEnabled", "screenShareEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "videoEnabled": obj.get("videoEnabled"),
            "screenShareEnabled": obj.get("screenShareEnabled")
        })
        return _obj
