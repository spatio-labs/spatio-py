...
class CreateBlockRequest(BaseModel):
    ...
    parent_id: Optional[StrictStr] = Field(default=None, description="Parent block id for nested blocks.", alias="parentId")
    position: StrictInt
    properties: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["type", "content", "parentId", "position", "properties"]
