...
class IntrospectionResponse(BaseModel):
    ...
    """ # noqa: E501
    active: StrictBool
    token_type: Optional[StrictStr] = Field(default=None, description="`oauth` or `pat`.")
    client_id: Optional[StrictStr] = None
    user_id: Optional[StrictStr] = None
    workspace_id: Optional[StrictStr] = None
    scope: Optional[StrictStr] = None
    exp: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["active", "token_type", "client_id", "user_id", "workspace_id", "scope", "exp"]
