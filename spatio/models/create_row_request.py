...
class CreateRowRequest(BaseModel):
    ...
    CreateRowRequest
    """ # noqa: E501
    index: Optional[StrictInt] = Field(default=None, description="Optional zero-based insert position. Omit to append at the end. ")
    cells: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["index", "cells"]
