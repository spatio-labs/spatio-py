...
class Presentation(BaseModel):
    ...
    theme: Optional[StrictStr] = Field(default=None, description="Free-form theme id; provider-specific.")
    ...
    __properties: ClassVar[List[str]] = ["id", "provider", "accountId", "ownerUserId", "title", "description", "theme", "thumbnailUrl", "createdAt", "updatedAt", "lastViewedAt"]
