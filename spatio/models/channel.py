...
class Channel(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    provider: Optional[StrictStr] = Field(default=None, description="Registered provider id (e.g. `slack`, `native-chat`). ")
    account_id: Optional[StrictStr] = Field(default=None, alias="accountId")
    name: StrictStr
    type: StrictStr = Field(description="Provider-specific. Common canonicals: `channel` and `private` (group channels), `im` (1:1 DM), `mpim` (group DM). ")
    description: Optional[StrictStr] = None
    topic: Optional[StrictStr] = None
    is_member: StrictBool = Field(alias="isMember")
    ...
    __properties: ClassVar[List[str]] = ["id", "provider", "accountId", "name", "type", "description", "topic", "isMember", "isArchived", "memberCount", "createdAt"]
