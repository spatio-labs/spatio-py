...
class InitChunkedUploadRequest(BaseModel):
    ...
    expected_blocks: List[StrictStr] = Field(description="Hashes of every block the client intends to upload.", alias="expectedBlocks")
    ...
    __properties: ClassVar[List[str]] = ["fileName", "totalSize", "mimeType", "expectedBlocks", "folderId", "workspaceId", "organizationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expectedBlocks": obj.get("expectedBlocks"),
