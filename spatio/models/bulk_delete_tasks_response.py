...
class BulkDeleteTasksResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool
    affected_count: StrictInt = Field(alias="affectedCount")
    task_ids: List[StrictStr] = Field(alias="taskIds")
    failed: List[BulkDeleteTasksResponseFailedInner]
    __properties: ClassVar[List[str]] = ["success", "affectedCount", "taskIds", "failed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [BulkDeleteTasksResponseFailedInner.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
