...
class Agent(BaseModel):
    ...
    is_preconfigured: Optional[StrictBool] = Field(default=None, alias="isPreconfigured")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "systemPrompt", "tools", "icon", "color", "isDefault", "isPreconfigured", "createdAt", "updatedAt", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isPreconfigured": obj.get("isPreconfigured"),
