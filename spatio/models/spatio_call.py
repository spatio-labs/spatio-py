...
class SpatioCall(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "status", "hostUserId", "workspaceId", "roomId", "participants", "metadata", "startedAt", "endedAt", "createdAt"]
