...
class CalendarProviderInfo(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Stable provider id (e.g. `google-calendar`, `native-calendar`).")
    name: StrictStr
    display_name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    is_system: Optional[StrictBool] = Field(default=None, description="`true` for built-in providers (the native calendar).")
    __properties: ClassVar[List[str]] = ["id", "name", "display_name", "description", "is_system"]
