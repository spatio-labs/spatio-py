...
class DMAttachRequest(BaseModel):
    """
    DMAttachRequest
    """ # noqa: E501
    kind: StrictStr = Field(description="Attachment kind (`image`, `file`, `audio`, `video`, etc.).")
    url: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["kind", "url", "filename", "sizeBytes", "mimeType", "thumbnailUrl", "width", "height", "accountId"]
