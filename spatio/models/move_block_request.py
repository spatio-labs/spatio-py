...
class MoveBlockRequest(BaseModel):
    ...
    MoveBlockRequest
    """ # noqa: E501
    parent_id: Optional[StrictStr] = Field(default=None, description="New parent block id; omit to keep the current parent.", alias="parentId")
    position: StrictInt
    __properties: ClassVar[List[str]] = ["parentId", "position"]
