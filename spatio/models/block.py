...
class Block(BaseModel):
    ...
    position: StrictInt = Field(description="Order within the parent (0-indexed).")
    has_children: StrictBool = Field(alias="hasChildren")
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "noteId", "parentId", "type", "content", "properties", "position", "hasChildren", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "content": BlockContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
