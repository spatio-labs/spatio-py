...
class ChatActionsList(BaseModel):
    """
    ChatActionsList
    """ # noqa: E501
    actions: List[ChatActionDefinition]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": [ChatActionDefinition.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
