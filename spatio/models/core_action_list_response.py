...
class CoreActionListResponse(BaseModel):
    """
    CoreActionListResponse
    """ # noqa: E501
    actions: Optional[List[CoreAction]]
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["actions", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": [CoreAction.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None,
            "total": obj.get("total")
        })
        return _obj
