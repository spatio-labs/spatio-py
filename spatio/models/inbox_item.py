...
class InboxItem(BaseModel):
    ...
    is_mention: Optional[StrictBool] = Field(default=None, alias="isMention")
    timestamp: Optional[datetime] = None
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "category", "title", "snippet", "source", "sourceId", "accountId", "isRead", "isMention", "timestamp", "metadata"]
