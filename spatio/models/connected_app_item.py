...
class ConnectedAppItem(BaseModel):
    ...
    scope_labels: List[StrictStr]
    granted_at: datetime
    __properties: ClassVar[List[str]] = ["client_id", "client_name", "logo_uri", "client_uri", "policy_uri", "tos_uri", "scopes", "scope_labels", "granted_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scope_labels": obj.get("scope_labels"),
