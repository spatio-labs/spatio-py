...
class TaskComment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "taskId", "content", "createdAt", "updatedAt", "author"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author": TaskCommentAuthor.from_dict(obj["author"]) if obj.get("author") is not None else None
        })
        return _obj
