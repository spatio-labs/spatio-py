...
class RecordTypeListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["record_types"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in record_types (list)
        _items = []
        if self.record_types:
            for _item_record_types in self.record_types:
                if _item_record_types:
                    _items.append(_item_record_types.to_dict())
            _dict['record_types'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "record_types": [RecordType.from_dict(_item) for _item in obj["record_types"]] if obj.get("record_types") is not None else None
        })
        return _obj
