...
class AmbiguousAccountError(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["error", "code", "accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "code": obj.get("code"),
            "accounts": [AccountChoice.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
