...
class OAuthError(BaseModel):
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['invalid_request', 'invalid_client', 'invalid_grant', 'unauthorized_client', 'unsupported_grant_type', 'unsupported_response_type', 'invalid_scope', 'access_denied', 'server_error', 'temporarily_unavailable', 'invalid_token', 'invalid_redirect_uri', 'invalid_client_metadata', 'login_required', 'consent_required', 'interaction_required', 'rate_limit_exceeded']):
            raise ValueError("must be one of enum values ('invalid_request', 'invalid_client', 'invalid_grant', 'unauthorized_client', 'unsupported_grant_type', 'unsupported_response_type', 'invalid_scope', 'access_denied', 'server_error', 'temporarily_unavailable', 'invalid_token', 'invalid_redirect_uri', 'invalid_client_metadata', 'login_required', 'consent_required', 'interaction_required', 'rate_limit_exceeded')")
        return value
