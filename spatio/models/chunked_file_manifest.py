...
class ChunkedFileManifest(BaseModel):
    """
    ...
    block_count: StrictInt = Field(alias="blockCount")
    chunking_algorithm: Optional[StrictStr] = Field(default=None, alias="chunkingAlgorithm")
    file_checksum: Optional[StrictStr] = Field(default=None, alias="fileChecksum")
    blocks: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["manifestId", "fileId", "fileName", "version", "totalSize", "blockCount", "chunkingAlgorithm", "fileChecksum", "blocks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockCount": obj.get("blockCount"),
            "chunkingAlgorithm": obj.get("chunkingAlgorithm"),
