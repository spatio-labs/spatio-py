...
class PreconfiguredAgent(BaseModel):
    """
    ...
    has_all_tools: Optional[StrictBool] = Field(default=None, alias="hasAllTools")
    tool_count: Optional[StrictInt] = Field(default=None, alias="toolCount")
    __properties: ClassVar[List[str]] = ["agentId", "name", "tagline", "description", "icon", "hasAllTools", "toolCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": obj.get("icon"),
            "hasAllTools": obj.get("hasAllTools"),
