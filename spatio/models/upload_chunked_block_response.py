...
class UploadChunkedBlockResponse(BaseModel):
    """
    UploadChunkedBlockResponse
    """ # noqa: E501
    block_hash: StrictStr = Field(alias="blockHash")
    uploaded: StrictBool
    blocks_remaining: StrictInt = Field(alias="blocksRemaining")
    progress: Union[StrictFloat, StrictInt] = Field(description="Percent complete, 0–100.")
    __properties: ClassVar[List[str]] = ["blockHash", "uploaded", "blocksRemaining", "progress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blocksRemaining": obj.get("blocksRemaining"),
