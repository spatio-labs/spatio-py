...
class ChangePasswordRequest(BaseModel):
    ...
    """ # noqa: E501
    current_password: Optional[StrictStr] = Field(default=None, description="Required when the account already has a password set; omit on first-set.", alias="currentPassword")
