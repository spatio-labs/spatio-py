...
class EnableShareRequest(BaseModel):
    ...
    """ # noqa: E501
    set_password: Optional[StrictBool] = Field(default=None, alias="setPassword")
    password: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["setPassword", "password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "setPassword": obj.get("setPassword"),
