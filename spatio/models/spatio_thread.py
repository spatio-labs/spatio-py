...
class SpatioThread(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "messages", "snippet", "labels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "messages": [Email.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
