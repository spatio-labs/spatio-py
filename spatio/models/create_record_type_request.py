...
class CreateRecordTypeRequest(BaseModel):
    """
    ...
    attribute_schema: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["organization_id", "slug", "name", "name_plural", "icon", "attribute_schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": obj.get("icon"),
            "attribute_schema": obj.get("attribute_schema")
        })
        return _obj
