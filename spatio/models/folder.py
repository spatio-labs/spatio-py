...
class Folder(BaseModel):
    ...
    path: StrictStr = Field(description="Display path from the root (e.g. `/Finance/Q3`).")
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "provider", "accountId", "name", "parentId", "path", "createdAt", "updatedAt"]
