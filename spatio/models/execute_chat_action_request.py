...
class ExecuteChatActionRequest(BaseModel):
    ...
    """ # noqa: E501
    action_id: StrictStr
    params: Optional[Any] = Field(default=None, description="Action-specific parameters. Free-form because the shape depends on `action_id`. See `GET /actions` for the per-id contract. ")
    __properties: ClassVar[List[str]] = ["action_id", "params"]
