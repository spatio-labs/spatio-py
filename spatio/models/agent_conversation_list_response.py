...
class AgentConversationListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["conversations", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversations": [AgentConversation.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
            "total": obj.get("total")
        })
        return _obj
