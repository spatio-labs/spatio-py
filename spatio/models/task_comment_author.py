...
class TaskCommentAuthor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "email", "profilePhoto"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if profile_photo (nullable) is None
        # and model_fields_set contains the field
        if self.profile_photo is None and "profile_photo" in self.model_fields_set:
            _dict['profilePhoto'] = None
