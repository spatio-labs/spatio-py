...
class CreateOrganizationInvitationRequest(BaseModel):
    ...
    email: StrictStr
    role: StrictStr
    workspace_id: Optional[StrictStr] = Field(default=None, description="Optional — the invitee will also be added to this workspace on accept. Defaults to the org's default workspace. ", alias="workspaceId")
    __properties: ClassVar[List[str]] = ["email", "role", "workspaceId"]
