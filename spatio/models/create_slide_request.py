...
class CreateSlideRequest(BaseModel):
    ...
    """ # noqa: E501
    presentation_id: Optional[StrictStr] = Field(default=None, alias="presentationId")
    ...
    __properties: ClassVar[List[str]] = ["presentationId", "title", "notes", "layout", "backgroundColor", "backgroundImageUrl", "textColor", "transition", "position"]
