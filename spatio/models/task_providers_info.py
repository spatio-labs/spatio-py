...
class TaskProvidersInfo(BaseModel):
    """
    Metadata about which task providers are connected and what the Tasks platform itself reports for its name + description. 
    """ # noqa: E501
    providers: List[StrictStr] = Field(description="Registered provider ids (e.g. `native-tasks`, `linear`).")
    platform: TaskProvidersInfoPlatform
    __properties: ClassVar[List[str]] = ["providers", "platform"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "platform": TaskProvidersInfoPlatform.from_dict(obj["platform"]) if obj.get("platform") is not None else None
        })
        return _obj
