...
class BulkMarkReadResponse(BaseModel):
    ...
    """ # noqa: E501
    updated: StrictInt = Field(description="Number of messages successfully marked.")
    failed: List[BulkMarkReadResponseFailedInner]
    __properties: ClassVar[List[str]] = ["updated", "failed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [BulkMarkReadResponseFailedInner.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
