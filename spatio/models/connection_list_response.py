...
class ConnectionListResponse(BaseModel):
    ...
    """ # noqa: E501
    connections: List[SpatioConnection]
    categories: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["connections", "categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connections": [SpatioConnection.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None,
