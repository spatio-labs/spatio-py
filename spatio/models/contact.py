...
class Contact(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "organization_id", "first_name", "last_name", "email", "phone", "company", "title", "notes", "scope", "provider", "metadata", "created_at", "updated_at"]
