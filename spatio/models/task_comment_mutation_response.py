...
class TaskCommentMutationResponse(BaseModel):
    """
    TaskCommentMutationResponse
    """ # noqa: E501
    comment: TaskComment
    success: StrictBool
    __properties: ClassVar[List[str]] = ["comment", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comment": TaskComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
