...
class KeyBindingListResponse(BaseModel):
    """
    KeyBindingListResponse
    """ # noqa: E501
    bindings: List[KeyBinding]
    __properties: ClassVar[List[str]] = ["bindings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bindings": [KeyBinding.from_dict(_item) for _item in obj["bindings"]] if obj.get("bindings") is not None else None
        })
        return _obj
