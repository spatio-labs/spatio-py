...
class CreateDraftRequest(BaseModel):
    ...
    thread_id: Optional[StrictStr] = Field(default=None, description="Provider thread id — set when this draft is a reply, so the sent message lands inside the parent thread. ", alias="threadId")
    in_reply_to: Optional[StrictStr] = Field(default=None, alias="inReplyTo")
    references: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["accountId", "to", "cc", "bcc", "subject", "body", "html", "attachments", "threadId", "inReplyTo", "references"]
