...
class SendChatMessageRequest(BaseModel):
    ...
    channel: StrictStr = Field(description="Channel or DM id (provider-scoped).")
    text: StrictStr
    thread_id: Optional[StrictStr] = Field(default=None, alias="threadId")
    blocks: Optional[List[Dict[str, Any]]] = Field(default=None, description="Provider-specific rich-message blocks.")
    __properties: ClassVar[List[str]] = ["accountId", "channel", "text", "threadId", "blocks"]
