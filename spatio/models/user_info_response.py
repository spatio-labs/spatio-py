...
class UserInfoResponse(BaseModel):
    ...
    UserInfoResponse
    """ # noqa: E501
    sub: StrictStr = Field(description="User identifier (stable for the lifetime of the user).")
    ...
    __properties: ClassVar[List[str]] = ["sub", "email", "email_verified", "name", "given_name", "family_name", "preferred_username", "picture", "updated_at"]
