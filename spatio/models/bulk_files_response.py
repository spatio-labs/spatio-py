...
class BulkFilesResponse(BaseModel):
    ...
    failed: List[BulkFilesResponseFailedInner]
    __properties: ClassVar[List[str]] = ["success", "affectedCount", "fileIds", "failed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [BulkFilesResponseFailedInner.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
