...
class DMForwardRequest(BaseModel):
    """
    Forward to either a DM (`toDmId`) or a channel (`toChannelId`); exactly one required.
    """ # noqa: E501
    to_dm_id: Optional[StrictStr] = Field(default=None, alias="toDmId")
    to_channel_id: Optional[StrictStr] = Field(default=None, alias="toChannelId")
    account_id: Optional[StrictStr] = Field(default=None, alias="accountId")
    __properties: ClassVar[List[str]] = ["toDmId", "toChannelId", "accountId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "toDmId": obj.get("toDmId"),
            "toChannelId": obj.get("toChannelId"),
