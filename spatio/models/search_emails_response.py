...
class SearchEmailsResponse(BaseModel):
    ...
    """ # noqa: E501
    emails: Optional[List[Email]] = Field(default=None, description="`null` when there are no results (Go nil-slice serialization). Treat as equivalent to an empty array. ")
    total: StrictInt
    next_page_token: Optional[StrictStr] = Field(default=None, alias="nextPageToken")
    provider: StrictStr
    __properties: ClassVar[List[str]] = ["emails", "total", "nextPageToken", "provider"]
