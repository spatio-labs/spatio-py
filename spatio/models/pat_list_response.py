...
class PATListResponse(BaseModel):
    ...
    available_scopes: Optional[List[StrictStr]] = Field(default=None, alias="availableScopes")
    __properties: ClassVar[List[str]] = ["tokens", "availableScopes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tokens": [PersonalAccessToken.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None,
            "availableScopes": obj.get("availableScopes")
        })
        return _obj
