...
class ChatActionDefinition(BaseModel):
    """
    ...
    platform: StrictStr
    category: Optional[StrictStr] = Field(default=None, description="Common values: `read`, `write`, `delete`, `manage`, `sync`.")
    ...
    scopes: Optional[List[StrictStr]] = Field(default=None, description="`null` when no scopes are declared (Go nil-slice).")
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "platform", "category", "inputType", "outputType", "scopes", "metadata"]
