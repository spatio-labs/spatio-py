...
class DownloadFileResponse(BaseModel):
    ...
    """ # noqa: E501
    signed_url: StrictStr = Field(description="Pre-signed direct-download URL pointing at the backing storage (R2, Drive, etc.). Time-limited per provider. Clients follow the URL — the platform does not proxy bytes. ", alias="signedUrl")
    file: SpatioFile
    __properties: ClassVar[List[str]] = ["signedUrl", "file"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file": SpatioFile.from_dict(obj["file"]) if obj.get("file") is not None else None
        })
        return _obj
