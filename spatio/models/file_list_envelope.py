...
class FileListEnvelope(BaseModel):
    """
    Fan-out list response for `GET /v1/files`.
    """ # noqa: E501
    items: Optional[List[SpatioFile]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [SpatioFile.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
