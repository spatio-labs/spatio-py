...
class Label(BaseModel):
    ...
    id: StrictStr
    name: StrictStr
    type: StrictStr = Field(description="Provider-specific label type. Common values: `system`, `user`. Not enumerated to avoid forcing a breaking change every time a provider adds one. ")
    message_list_visibility: Optional[StrictStr] = Field(default=None, alias="messageListVisibility")
    label_list_visibility: Optional[StrictStr] = Field(default=None, alias="labelListVisibility")
    color: Optional[LabelColor] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "messageListVisibility", "labelListVisibility", "color"]
