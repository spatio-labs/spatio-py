...
class TestSignInMethodsProvidersInner(unittest.TestCase):
    """SignInMethodsProvidersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignInMethodsProvidersInner:
        ...
        """
        model = SignInMethodsProvidersInner()
        if include_optional:
    ...
    def testSignInMethodsProvidersInner(self):
        """Test SignInMethodsProvidersInner"""
