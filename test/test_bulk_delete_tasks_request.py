...
class TestBulkDeleteTasksRequest(unittest.TestCase):
    """BulkDeleteTasksRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteTasksRequest:
    ...
    def testBulkDeleteTasksRequest(self):
        """Test BulkDeleteTasksRequest"""
