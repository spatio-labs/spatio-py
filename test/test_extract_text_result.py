...
class TestExtractTextResult(unittest.TestCase):
    """ExtractTextResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtractTextResult:
    ...
    def testExtractTextResult(self):
        """Test ExtractTextResult"""
