...
class TestPATScopesResponse(unittest.TestCase):
    """PATScopesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PATScopesResponse:
    ...
    def testPATScopesResponse(self):
        """Test PATScopesResponse"""
