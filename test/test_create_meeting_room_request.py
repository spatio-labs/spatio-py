...
class TestCreateMeetingRoomRequest(unittest.TestCase):
    """CreateMeetingRoomRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMeetingRoomRequest:
    ...
    def testCreateMeetingRoomRequest(self):
        """Test CreateMeetingRoomRequest"""
