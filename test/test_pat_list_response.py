...
class TestPATListResponse(unittest.TestCase):
    """PATListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PATListResponse:
        ...
        if include_optional:
            return PATListResponse(
                tokens = [
                    spatio.models.personal_access_token.PersonalAccessToken(
                        id = '', 
                        name = '', 
                        description = '', 
                        scopes = [
