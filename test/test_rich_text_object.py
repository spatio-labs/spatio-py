...
class TestRichTextObject(unittest.TestCase):
    """RichTextObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RichTextObject:
        """Test RichTextObject
