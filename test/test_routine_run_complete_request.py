...
class TestRoutineRunCompleteRequest(unittest.TestCase):
    """RoutineRunCompleteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutineRunCompleteRequest:
        ...
        """
        model = RoutineRunCompleteRequest()
        if include_optional:
            return RoutineRunCompleteRequest(
                status = '',
                metadata = { }
            )
        else:
    ...
    def testRoutineRunCompleteRequest(self):
        """Test RoutineRunCompleteRequest"""
