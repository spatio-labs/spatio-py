...
class TestCreateEmailFolderRequest(unittest.TestCase):
    """CreateEmailFolderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateEmailFolderRequest:
        ...
        """
        model = CreateEmailFolderRequest()
        if include_optional:
            return CreateEmailFolderRequest(
                name = '',
                account_id = ''
            )
        else:
    ...
    def testCreateEmailFolderRequest(self):
        """Test CreateEmailFolderRequest"""
