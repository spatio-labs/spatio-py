...
class TestUpdateRoutineRequest(unittest.TestCase):
    """UpdateRoutineRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateRoutineRequest:
    ...
    def testUpdateRoutineRequest(self):
        """Test UpdateRoutineRequest"""
