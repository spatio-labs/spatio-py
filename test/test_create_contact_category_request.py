...
class TestCreateContactCategoryRequest(unittest.TestCase):
    """CreateContactCategoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateContactCategoryRequest:
        ...
        """
        model = CreateContactCategoryRequest()
        if include_optional:
    ...
    def testCreateContactCategoryRequest(self):
        """Test CreateContactCategoryRequest"""
