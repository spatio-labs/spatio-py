...
class TestTaskCommentList(unittest.TestCase):
    """TaskCommentList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskCommentList:
        ...
        if include_optional:
            return TaskCommentList(
                comments = [
                    spatio.models.task_comment.TaskComment(
                        id = '', 
                        task_id = '', 
                        content = '', 
