...
class TestAssignContactCategoryRequest(unittest.TestCase):
    """AssignContactCategoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignContactCategoryRequest:
        ...
        """
        model = AssignContactCategoryRequest()
        if include_optional:
    ...
    def testAssignContactCategoryRequest(self):
        """Test AssignContactCategoryRequest"""
