...
class TestTaskCommentAuthor(unittest.TestCase):
    """TaskCommentAuthor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskCommentAuthor:
    ...
    def testTaskCommentAuthor(self):
        """Test TaskCommentAuthor"""
