...
class TestAgentTaskUsage(unittest.TestCase):
    """AgentTaskUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentTaskUsage:
        """Test AgentTaskUsage
