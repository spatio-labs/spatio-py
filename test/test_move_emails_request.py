...
class TestMoveEmailsRequest(unittest.TestCase):
    """MoveEmailsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveEmailsRequest:
        ...
        """
        model = MoveEmailsRequest()
        if include_optional:
            return MoveEmailsRequest(
                message_ids = [
                    ''
                    ]
            )
    ...
    def testMoveEmailsRequest(self):
        """Test MoveEmailsRequest"""
