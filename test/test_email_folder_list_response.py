...
class TestEmailFolderListResponse(unittest.TestCase):
    """EmailFolderListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailFolderListResponse:
        ...
        """
        model = EmailFolderListResponse()
        if include_optional:
            return EmailFolderListResponse(
                folders = [
                    spatio.models.email_folder.EmailFolder(
                        id = '', 
                        name = '', 
                        account_id = '', 
                        metadata = { }, 
    ...
    def testEmailFolderListResponse(self):
        """Test EmailFolderListResponse"""
