...
class TestSlideElementList(unittest.TestCase):
    """SlideElementList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlideElementList:
        ...
        """
        model = SlideElementList()
        if include_optional:
            return SlideElementList(
                elements = [
                    spatio.models.slide_element.SlideElement(
                        id = '', 
                        slide_id = '', 
                        element_type = '', 
                        content = { }, 
