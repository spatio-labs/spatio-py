...
class TestShareSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShareSettings:
        """Test ShareSettings
        ...
        if include_optional:
            return ShareSettings(
                ...
                share_token = '',
                share_url = '',
                password_set_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f')
            )
        else:
            return ShareSettings(
                is_public = True,
