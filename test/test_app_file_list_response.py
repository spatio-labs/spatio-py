...
class TestAppFileListResponse(unittest.TestCase):
    """AppFileListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppFileListResponse:
    ...
    def testAppFileListResponse(self):
        """Test AppFileListResponse"""
