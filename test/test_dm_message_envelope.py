...
class TestDMMessageEnvelope(unittest.TestCase):
    """DMMessageEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMMessageEnvelope:
        ...
        """
        model = DMMessageEnvelope()
        if include_optional:
            return DMMessageEnvelope(
                message = spatio.models.chat_message.ChatMessage(
                    id = '', 
                    provider = '', 
                    account_id = '', 
                    channel_id = '', 
    ...
    def testDMMessageEnvelope(self):
        """Test DMMessageEnvelope"""
