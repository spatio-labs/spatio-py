...
class TestCommitChunkedUploadResponse(unittest.TestCase):
    """CommitChunkedUploadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommitChunkedUploadResponse:
        ...
        """
        model = CommitChunkedUploadResponse()
        if include_optional:
            return CommitChunkedUploadResponse(
                ...
                total_size = 56,
                physical_size = 56,
                deduplication_pct = 1.337,
                total_blocks = 56,
                new_blocks = 56,
                deduplicated_blocks = 56
            )
        else:
            return CommitChunkedUploadResponse(
                success = True,
    ...
    def testCommitChunkedUploadResponse(self):
        """Test CommitChunkedUploadResponse"""
