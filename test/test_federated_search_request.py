...
class TestFederatedSearchRequest(unittest.TestCase):
    """FederatedSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FederatedSearchRequest:
    ...
    def testFederatedSearchRequest(self):
        """Test FederatedSearchRequest"""
