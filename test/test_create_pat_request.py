...
class TestCreatePATRequest(unittest.TestCase):
    """CreatePATRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePATRequest:
