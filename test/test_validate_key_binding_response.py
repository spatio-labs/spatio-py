...
class TestValidateKeyBindingResponse(unittest.TestCase):
    """ValidateKeyBindingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateKeyBindingResponse:
        ...
        """
        model = ValidateKeyBindingResponse()
        if include_optional:
    ...
    def testValidateKeyBindingResponse(self):
        """Test ValidateKeyBindingResponse"""
