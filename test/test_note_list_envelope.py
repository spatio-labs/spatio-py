...
class TestNoteListEnvelope(unittest.TestCase):
    """NoteListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteListEnvelope:
        ...
        """
        model = NoteListEnvelope()
        if include_optional:
            return NoteListEnvelope(
                items = [
                    spatio.models.note.Note(
                        id = '', 
                        provider = '', 
                        account_id = '', 
                        owner_user_id = '', 
