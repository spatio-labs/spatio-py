...
class TestTaskProvidersInfo(unittest.TestCase):
    """TaskProvidersInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskProvidersInfo:
        ...
        """
        model = TaskProvidersInfo()
        if include_optional:
            return TaskProvidersInfo(
                providers = [
                    ''
                    ],
                platform = spatio.models.task_providers_info_platform.TaskProvidersInfo_platform(
                    name = '', 
                    description = '', )
            )
        else:
    ...
    def testTaskProvidersInfo(self):
        """Test TaskProvidersInfo"""
