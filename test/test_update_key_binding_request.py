...
class TestUpdateKeyBindingRequest(unittest.TestCase):
    """UpdateKeyBindingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateKeyBindingRequest:
    ...
    def testUpdateKeyBindingRequest(self):
        """Test UpdateKeyBindingRequest"""
