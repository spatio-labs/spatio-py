...
class TestSendChatMessageRequest(unittest.TestCase):
    """SendChatMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendChatMessageRequest:
    ...
    def testSendChatMessageRequest(self):
        """Test SendChatMessageRequest"""
