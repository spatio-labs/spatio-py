...
class TestCallRecordingListResponse(unittest.TestCase):
    """CallRecordingListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallRecordingListResponse:
        ...
        """
        model = CallRecordingListResponse()
        if include_optional:
            return CallRecordingListResponse(
                recordings = [
                    spatio.models.call_recording.CallRecording(
                        id = '', 
                        call_id = '', 
                        status = '', 
    ...
    def testCallRecordingListResponse(self):
        """Test CallRecordingListResponse"""
