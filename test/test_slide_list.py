...
class TestSlideList(unittest.TestCase):
    """SlideList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlideList:
        """Test SlideList
