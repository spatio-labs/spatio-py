...
class TestWorkspaceMemberListResponse(unittest.TestCase):
    """WorkspaceMemberListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceMemberListResponse:
        ...
        if include_optional:
            return WorkspaceMemberListResponse(
                members = [
                    spatio.models.workspace_member.WorkspaceMember(
                        id = '', 
                        role = 'owner', 
                        email = '', 
                        name = '', 
    ...
    def testWorkspaceMemberListResponse(self):
        """Test WorkspaceMemberListResponse"""
