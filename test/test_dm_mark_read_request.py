...
class TestDMMarkReadRequest(unittest.TestCase):
    """DMMarkReadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMMarkReadRequest:
        ...
        """
        model = DMMarkReadRequest()
        if include_optional:
            return DMMarkReadRequest(
                message_id = '',
                account_id = ''
            )
        else:
    ...
    def testDMMarkReadRequest(self):
        """Test DMMarkReadRequest"""
