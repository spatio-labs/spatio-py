...
class TestBulkMarkReadRequest(unittest.TestCase):
    """BulkMarkReadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkMarkReadRequest:
        ...
        """
        model = BulkMarkReadRequest()
        if include_optional:
            return BulkMarkReadRequest(
                account_id = '',
                message_ids = [
                    ''
                    ],
    ...
    def testBulkMarkReadRequest(self):
        """Test BulkMarkReadRequest"""
