...
class TestUpdateSlideElementRequest(unittest.TestCase):
    """UpdateSlideElementRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSlideElementRequest:
        ...
        """
        model = UpdateSlideElementRequest()
        if include_optional:
            return UpdateSlideElementRequest(
                element_type = '',
                content = { },
                x = 1.337,
                y = 1.337,
    ...
    def testUpdateSlideElementRequest(self):
        """Test UpdateSlideElementRequest"""
