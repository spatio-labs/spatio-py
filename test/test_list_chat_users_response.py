...
class TestListChatUsersResponse(unittest.TestCase):
    """ListChatUsersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListChatUsersResponse:
        ...
        """
        model = ListChatUsersResponse()
        if include_optional:
            return ListChatUsersResponse(
                users = [
                    spatio.models.chat_user.ChatUser(
                        id = '', 
                        provider = '', 
                        account_id = '', 
                        name = '', 
    ...
    def testListChatUsersResponse(self):
        """Test ListChatUsersResponse"""
