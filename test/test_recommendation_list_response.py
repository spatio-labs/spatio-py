...
class TestRecommendationListResponse(unittest.TestCase):
    """RecommendationListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendationListResponse:
        ...
        if include_optional:
            return RecommendationListResponse(
                items = [
                    spatio.models.recommendation.Recommendation(
                        id = '', 
                        workspace_id = '', 
                        user_id = '', 
                        kind = '', 
    ...
    def testRecommendationListResponse(self):
        """Test RecommendationListResponse"""
