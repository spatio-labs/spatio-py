...
class TestOrganizationMemberInvitedBy(unittest.TestCase):
    """OrganizationMemberInvitedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationMemberInvitedBy:
        ...
        """
        model = OrganizationMemberInvitedBy()
        if include_optional:
    ...
    def testOrganizationMemberInvitedBy(self):
        """Test OrganizationMemberInvitedBy"""
