...
class TestDMMuteResponse(unittest.TestCase):
    """DMMuteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMMuteResponse:
        """Test DMMuteResponse
