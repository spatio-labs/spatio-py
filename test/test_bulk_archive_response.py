...
class TestBulkArchiveResponse(unittest.TestCase):
    """BulkArchiveResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkArchiveResponse:
    ...
    def testBulkArchiveResponse(self):
        """Test BulkArchiveResponse"""
