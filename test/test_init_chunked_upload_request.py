...
class TestInitChunkedUploadRequest(unittest.TestCase):
    """InitChunkedUploadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitChunkedUploadRequest:
        ...
        """
        model = InitChunkedUploadRequest()
        if include_optional:
    ...
    def testInitChunkedUploadRequest(self):
        """Test InitChunkedUploadRequest"""
