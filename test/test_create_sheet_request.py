...
class TestCreateSheetRequest(unittest.TestCase):
    """CreateSheetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSheetRequest:
    ...
    def testCreateSheetRequest(self):
        """Test CreateSheetRequest"""
