...
class TestWriteAppFileRequest(unittest.TestCase):
    """WriteAppFileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WriteAppFileRequest:
    ...
    def testWriteAppFileRequest(self):
        """Test WriteAppFileRequest"""
