...
class TestBulkUpdateTasksRequest(unittest.TestCase):
    """BulkUpdateTasksRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateTasksRequest:
        ...
        if include_optional:
            return BulkUpdateTasksRequest(
                ...
                account_id = '',
                updates = spatio.models.update_task_request.UpdateTaskRequest(
                    title = '', 
                    description = '', 
                    status = '', 
    ...
    def testBulkUpdateTasksRequest(self):
        """Test BulkUpdateTasksRequest"""
