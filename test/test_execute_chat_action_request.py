...
class TestExecuteChatActionRequest(unittest.TestCase):
    """ExecuteChatActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteChatActionRequest:
        ...
        """
        model = ExecuteChatActionRequest()
        if include_optional:
    ...
    def testExecuteChatActionRequest(self):
        """Test ExecuteChatActionRequest"""
