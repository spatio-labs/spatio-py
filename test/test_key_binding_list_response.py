...
class TestKeyBindingListResponse(unittest.TestCase):
    """KeyBindingListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyBindingListResponse:
        ...
        """
        model = KeyBindingListResponse()
        if include_optional:
            return KeyBindingListResponse(
                bindings = [
                    spatio.models.key_binding.KeyBinding(
                        id = '', 
                        action_id = '', 
                        display_name = '', 
                        description = '', 
    ...
    def testKeyBindingListResponse(self):
        """Test KeyBindingListResponse"""
