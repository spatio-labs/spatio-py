...
class TestChunkedFileManifest(unittest.TestCase):
    """ChunkedFileManifest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChunkedFileManifest:
    ...
    def testChunkedFileManifest(self):
        """Test ChunkedFileManifest"""
