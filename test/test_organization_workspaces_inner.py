...
class TestOrganizationWorkspacesInner(unittest.TestCase):
    """OrganizationWorkspacesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationWorkspacesInner:
        ...
        """
        model = OrganizationWorkspacesInner()
        if include_optional:
    ...
    def testOrganizationWorkspacesInner(self):
        """Test OrganizationWorkspacesInner"""
