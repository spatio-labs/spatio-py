...
class TestBulkDeleteTasksResponseFailedInner(unittest.TestCase):
    """BulkDeleteTasksResponseFailedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteTasksResponseFailedInner:
        ...
        """
        model = BulkDeleteTasksResponseFailedInner()
        if include_optional:
    ...
    def testBulkDeleteTasksResponseFailedInner(self):
        """Test BulkDeleteTasksResponseFailedInner"""
