...
class TestInstallConnectionRequest(unittest.TestCase):
    """InstallConnectionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstallConnectionRequest:
        ...
        """
        model = InstallConnectionRequest()
        if include_optional:
    ...
    def testInstallConnectionRequest(self):
        """Test InstallConnectionRequest"""
