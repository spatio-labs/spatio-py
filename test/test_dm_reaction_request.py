...
class TestDMReactionRequest(unittest.TestCase):
    """DMReactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMReactionRequest:
    ...
    def testDMReactionRequest(self):
        """Test DMReactionRequest"""
