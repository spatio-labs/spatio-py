...
class TestExportPDFRequest(unittest.TestCase):
    """ExportPDFRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPDFRequest:
        ...
        """
        model = ExportPDFRequest()
        if include_optional:
            return ExportPDFRequest(
                rasterized_slides = [
                    spatio.models.export_pdf_request_rasterized_slides_inner.ExportPDFRequest_rasterizedSlides_inner(
                        slide_id = '', 
                        png = '', )
                    ],
                theme = { }
