...
class TestSignInMethods(unittest.TestCase):
    """SignInMethods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignInMethods:
        """Test SignInMethods
        ...
        if include_optional:
            return SignInMethods(
                ...
                has_password = True,
                providers = [
                    spatio.models.sign_in_methods_providers_inner.SignInMethods_providers_inner(
                        provider = '', 
                        account_email = '', 
