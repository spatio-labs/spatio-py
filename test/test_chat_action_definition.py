...
class TestChatActionDefinition(unittest.TestCase):
    """ChatActionDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatActionDefinition:
    ...
    def testChatActionDefinition(self):
        """Test ChatActionDefinition"""
