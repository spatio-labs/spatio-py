...
class TestRoutineRunListResponse(unittest.TestCase):
    """RoutineRunListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutineRunListResponse:
        ...
        """
        model = RoutineRunListResponse()
        if include_optional:
            return RoutineRunListResponse(
                items = [
                    spatio.models.routine_run.RoutineRun(
                        id = '', 
                        routine_id = '', 
                        status = '', 
                        progress = 56, 
    ...
    def testRoutineRunListResponse(self):
        """Test RoutineRunListResponse"""
