...
class TestAgentConversationListResponse(unittest.TestCase):
    """AgentConversationListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentConversationListResponse:
        ...
        if include_optional:
            return AgentConversationListResponse(
                conversations = [
                    spatio.models.agent_conversation.AgentConversation(
                        id = '', 
                        agent_id = '', 
                        title = '', 
                        metadata = { }, 
    ...
    def testAgentConversationListResponse(self):
        """Test AgentConversationListResponse"""
