...
class TestTaskCommentRequest(unittest.TestCase):
    """TaskCommentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskCommentRequest:
    ...
    def testTaskCommentRequest(self):
        """Test TaskCommentRequest"""
