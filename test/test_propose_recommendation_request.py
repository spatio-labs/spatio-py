...
class TestProposeRecommendationRequest(unittest.TestCase):
    """ProposeRecommendationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProposeRecommendationRequest:
        ...
        """
        model = ProposeRecommendationRequest()
        if include_optional:
    ...
    def testProposeRecommendationRequest(self):
        """Test ProposeRecommendationRequest"""
