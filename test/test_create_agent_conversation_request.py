...
class TestCreateAgentConversationRequest(unittest.TestCase):
    """CreateAgentConversationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAgentConversationRequest:
        ...
        """
        model = CreateAgentConversationRequest()
        if include_optional:
    ...
    def testCreateAgentConversationRequest(self):
        """Test CreateAgentConversationRequest"""
