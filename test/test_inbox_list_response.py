...
class TestInboxListResponse(unittest.TestCase):
    """InboxListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboxListResponse:
        ...
        """
        model = InboxListResponse()
        if include_optional:
            return InboxListResponse(
                items = [
                    spatio.models.inbox_item.InboxItem(
                        id = '', 
                        category = '', 
                        title = '', 
                        snippet = '', 
    ...
    def testInboxListResponse(self):
        """Test InboxListResponse"""
