...
class TestUpdateSheetRequest(unittest.TestCase):
    """UpdateSheetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSheetRequest:
    ...
    def testUpdateSheetRequest(self):
        """Test UpdateSheetRequest"""
