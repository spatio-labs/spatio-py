...
class TestUpdateMessageMetadataRequest(unittest.TestCase):
    """UpdateMessageMetadataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMessageMetadataRequest:
        ...
        """
        model = UpdateMessageMetadataRequest()
        if include_optional:
    ...
    def testUpdateMessageMetadataRequest(self):
        """Test UpdateMessageMetadataRequest"""
