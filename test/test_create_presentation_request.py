...
class TestCreatePresentationRequest(unittest.TestCase):
    """CreatePresentationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePresentationRequest:
        ...
        """
        model = CreatePresentationRequest()
        if include_optional:
    ...
    def testCreatePresentationRequest(self):
        """Test CreatePresentationRequest"""
