...
class TestAcceptOrganizationInvitationRequest(unittest.TestCase):
    """AcceptOrganizationInvitationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptOrganizationInvitationRequest:
        ...
        """
        model = AcceptOrganizationInvitationRequest()
        if include_optional:
    ...
    def testAcceptOrganizationInvitationRequest(self):
        """Test AcceptOrganizationInvitationRequest"""
