...
class TestValidateKeyBindingRequest(unittest.TestCase):
    """ValidateKeyBindingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateKeyBindingRequest:
        ...
        """
        model = ValidateKeyBindingRequest()
        if include_optional:
    ...
    def testValidateKeyBindingRequest(self):
        """Test ValidateKeyBindingRequest"""
