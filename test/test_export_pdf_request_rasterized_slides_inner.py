...
class TestExportPDFRequestRasterizedSlidesInner(unittest.TestCase):
    """ExportPDFRequestRasterizedSlidesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPDFRequestRasterizedSlidesInner:
        ...
        """
        model = ExportPDFRequestRasterizedSlidesInner()
        if include_optional:
    ...
    def testExportPDFRequestRasterizedSlidesInner(self):
        """Test ExportPDFRequestRasterizedSlidesInner"""
