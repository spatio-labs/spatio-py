...
class TestConnectionListResponse(unittest.TestCase):
    """ConnectionListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionListResponse:
        ...
        if include_optional:
            return ConnectionListResponse(
                connections = [
                    spatio.models.spatio_connection.SpatioConnection(
                        id = '', 
                        name = '', 
                        category = '', 
                        description = '', 
    ...
    def testConnectionListResponse(self):
        """Test ConnectionListResponse"""
