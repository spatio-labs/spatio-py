...
class TestUpdateParticipantStateRequest(unittest.TestCase):
    """UpdateParticipantStateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateParticipantStateRequest:
        ...
        """
        model = UpdateParticipantStateRequest()
        if include_optional:
    ...
    def testUpdateParticipantStateRequest(self):
        """Test UpdateParticipantStateRequest"""
