...
class TestUpdateOrganizationMemberRequest(unittest.TestCase):
    """UpdateOrganizationMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOrganizationMemberRequest:
    ...
    def testUpdateOrganizationMemberRequest(self):
        """Test UpdateOrganizationMemberRequest"""
