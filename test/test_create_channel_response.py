...
class TestCreateChannelResponse(unittest.TestCase):
    """CreateChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateChannelResponse:
        ...
        if include_optional:
            return CreateChannelResponse(
                channel = spatio.models.channel.Channel(
                    id = '', 
                    provider = '', 
                    account_id = '', 
                    name = '', 
    ...
    def testCreateChannelResponse(self):
        """Test CreateChannelResponse"""
