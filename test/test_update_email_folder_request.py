...
class TestUpdateEmailFolderRequest(unittest.TestCase):
    """UpdateEmailFolderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEmailFolderRequest:
        ...
        """
        model = UpdateEmailFolderRequest()
        if include_optional:
            return UpdateEmailFolderRequest(
                name = ''
            )
        else:
            return UpdateEmailFolderRequest(
    ...
    def testUpdateEmailFolderRequest(self):
        """Test UpdateEmailFolderRequest"""
