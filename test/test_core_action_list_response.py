...
class TestCoreActionListResponse(unittest.TestCase):
    """CoreActionListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreActionListResponse:
        ...
        """
        model = CoreActionListResponse()
        if include_optional:
            return CoreActionListResponse(
                actions = [
                    spatio.models.core_action.CoreAction(
                        id = '', 
                        name = '', 
                        description = '', 
                        platform = '', 
    ...
    def testCoreActionListResponse(self):
        """Test CoreActionListResponse"""
