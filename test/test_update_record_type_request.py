...
class TestUpdateRecordTypeRequest(unittest.TestCase):
    """UpdateRecordTypeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateRecordTypeRequest:
        ...
        """
        model = UpdateRecordTypeRequest()
        if include_optional:
            return UpdateRecordTypeRequest(
                slug = '',
                name = '',
                name_plural = '',
                icon = '',
    ...
    def testUpdateRecordTypeRequest(self):
        """Test UpdateRecordTypeRequest"""
