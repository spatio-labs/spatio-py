...
class TestEnableShareRequest(unittest.TestCase):
    """EnableShareRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnableShareRequest:
    ...
    def testEnableShareRequest(self):
        """Test EnableShareRequest"""
