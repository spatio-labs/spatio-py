...
class TestInitChunkedUploadResponse(unittest.TestCase):
    """InitChunkedUploadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitChunkedUploadResponse:
        ...
        """
        model = InitChunkedUploadResponse()
        if include_optional:
    ...
    def testInitChunkedUploadResponse(self):
        """Test InitChunkedUploadResponse"""
