...
class TestBulkDeleteEmailsRequest(unittest.TestCase):
    """BulkDeleteEmailsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteEmailsRequest:
        ...
        """
        model = BulkDeleteEmailsRequest()
        if include_optional:
            return BulkDeleteEmailsRequest(
                account_id = '',
                message_ids = [
                    ''
                    ],
    ...
    def testBulkDeleteEmailsRequest(self):
        """Test BulkDeleteEmailsRequest"""
