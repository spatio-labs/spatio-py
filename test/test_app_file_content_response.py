...
class TestAppFileContentResponse(unittest.TestCase):
    """AppFileContentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppFileContentResponse:
    ...
    def testAppFileContentResponse(self):
        """Test AppFileContentResponse"""
