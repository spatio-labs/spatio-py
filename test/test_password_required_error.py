...
class TestPasswordRequiredError(unittest.TestCase):
    """PasswordRequiredError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PasswordRequiredError:
    ...
    def testPasswordRequiredError(self):
        """Test PasswordRequiredError"""
