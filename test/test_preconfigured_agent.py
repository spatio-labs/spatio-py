...
class TestPreconfiguredAgent(unittest.TestCase):
    """PreconfiguredAgent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreconfiguredAgent:
    ...
    def testPreconfiguredAgent(self):
        """Test PreconfiguredAgent"""
