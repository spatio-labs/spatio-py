...
class TestReplyEmailRequest(unittest.TestCase):
    """ReplyEmailRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplyEmailRequest:
    ...
    def testReplyEmailRequest(self):
        """Test ReplyEmailRequest"""
