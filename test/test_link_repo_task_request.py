...
class TestLinkRepoTaskRequest(unittest.TestCase):
    """LinkRepoTaskRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkRepoTaskRequest:
    ...
    def testLinkRepoTaskRequest(self):
        """Test LinkRepoTaskRequest"""
