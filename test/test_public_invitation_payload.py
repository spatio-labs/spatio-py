...
class TestPublicInvitationPayload(unittest.TestCase):
    """PublicInvitationPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicInvitationPayload:
    ...
    def testPublicInvitationPayload(self):
        """Test PublicInvitationPayload"""
