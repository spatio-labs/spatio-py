...
class TestCreateWorkspaceInvitationRequest(unittest.TestCase):
    """CreateWorkspaceInvitationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWorkspaceInvitationRequest:
        ...
        """
        model = CreateWorkspaceInvitationRequest()
        if include_optional:
    ...
    def testCreateWorkspaceInvitationRequest(self):
        """Test CreateWorkspaceInvitationRequest"""
