...
class TestDMSearchResults(unittest.TestCase):
    """DMSearchResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMSearchResults:
