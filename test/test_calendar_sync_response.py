...
class TestCalendarSyncResponse(unittest.TestCase):
    """CalendarSyncResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarSyncResponse:
    ...
    def testCalendarSyncResponse(self):
        """Test CalendarSyncResponse"""
