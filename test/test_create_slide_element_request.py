...
class TestCreateSlideElementRequest(unittest.TestCase):
    """CreateSlideElementRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSlideElementRequest:
        ...
        """
        model = CreateSlideElementRequest()
        if include_optional:
    ...
    def testCreateSlideElementRequest(self):
        """Test CreateSlideElementRequest"""
