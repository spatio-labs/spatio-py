...
class TestCalendarCapabilitiesResponse(unittest.TestCase):
    """CalendarCapabilitiesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarCapabilitiesResponse:
        ...
        """
        model = CalendarCapabilitiesResponse()
        if include_optional:
    ...
    def testCalendarCapabilitiesResponse(self):
        """Test CalendarCapabilitiesResponse"""
