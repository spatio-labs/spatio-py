...
class TestCalendarOperationResult(unittest.TestCase):
    """CalendarOperationResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarOperationResult:
    ...
    def testCalendarOperationResult(self):
        """Test CalendarOperationResult"""
