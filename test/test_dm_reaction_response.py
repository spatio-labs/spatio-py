...
class TestDMReactionResponse(unittest.TestCase):
    """DMReactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMReactionResponse:
    ...
    def testDMReactionResponse(self):
        """Test DMReactionResponse"""
