...
class TestRecordTypeListResponse(unittest.TestCase):
    """RecordTypeListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordTypeListResponse:
        ...
        """
        model = RecordTypeListResponse()
        if include_optional:
            return RecordTypeListResponse(
                record_types = [
                    spatio.models.record_type.RecordType(
                        id = '', 
                        organization_id = '', 
                        slug = '', 
                        name = '', 
    ...
    def testRecordTypeListResponse(self):
        """Test RecordTypeListResponse"""
