...
class TestUpdateEmailResponse(unittest.TestCase):
    """UpdateEmailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateEmailResponse:
        ...
        """
        model = UpdateEmailResponse()
        if include_optional:
            return UpdateEmailResponse(
                email = spatio.models.email.Email(
                    id = '', 
                    thread_id = '', 
                    provider = '', 
                    account_id = '', 
    ...
    def testUpdateEmailResponse(self):
        """Test UpdateEmailResponse"""
