...
class TestCalendarProviderInfo(unittest.TestCase):
    """CalendarProviderInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarProviderInfo:
    ...
    def testCalendarProviderInfo(self):
        """Test CalendarProviderInfo"""
