...
class TestIssueCollaborationTokenRequest(unittest.TestCase):
    """IssueCollaborationTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IssueCollaborationTokenRequest:
        ...
        """
        model = IssueCollaborationTokenRequest()
        if include_optional:
    ...
    def testIssueCollaborationTokenRequest(self):
        """Test IssueCollaborationTokenRequest"""
