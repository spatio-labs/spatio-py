...
class TestRoutineListResponse(unittest.TestCase):
    """RoutineListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutineListResponse:
    ...
    def testRoutineListResponse(self):
        """Test RoutineListResponse"""
