...
class TestBulkDeleteFilesRequest(unittest.TestCase):
    """BulkDeleteFilesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteFilesRequest:
    ...
    def testBulkDeleteFilesRequest(self):
        """Test BulkDeleteFilesRequest"""
