...
class TestSheetListEnvelope(unittest.TestCase):
    """SheetListEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SheetListEnvelope:
        ...
        """
        model = SheetListEnvelope()
        if include_optional:
            return SheetListEnvelope(
                items = [
                    spatio.models.sheet.Sheet(
                        id = '', 
                        provider = '', 
                        account_id = '', 
                        owner_user_id = '', 
    ...
    def testSheetListEnvelope(self):
        """Test SheetListEnvelope"""
