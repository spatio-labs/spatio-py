...
class TestChannelMembershipRequest(unittest.TestCase):
    """ChannelMembershipRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelMembershipRequest:
        ...
        """
        model = ChannelMembershipRequest()
        if include_optional:
    ...
    def testChannelMembershipRequest(self):
        """Test ChannelMembershipRequest"""
