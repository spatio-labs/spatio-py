...
class TestSaveMessageRequest(unittest.TestCase):
    """SaveMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveMessageRequest:
    ...
    def testSaveMessageRequest(self):
        """Test SaveMessageRequest"""
