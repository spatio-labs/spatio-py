...
class TestWorkspaceEnvelope(unittest.TestCase):
    """WorkspaceEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceEnvelope:
        ...
        """
        model = WorkspaceEnvelope()
        if include_optional:
            return WorkspaceEnvelope(
                workspace = spatio.models.workspace.Workspace(
                    id = '', 
                    name = '', 
                    slug = '', 
                    description = '', 
                    logo_url = '', 
                    organization_id = '', 
                    organization = spatio.models.workspace_organization.Workspace_organization(
                        id = '', 
                        name = '', 
                        slug = '', ), 
                    role = '', 
    ...
    def testWorkspaceEnvelope(self):
        """Test WorkspaceEnvelope"""
