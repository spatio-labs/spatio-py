...
class TestCreateNote400Response(unittest.TestCase):
    """CreateNote400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNote400Response:
        ...
        """
        model = CreateNote400Response()
        if include_optional:
            return CreateNote400Response(
                error = 'user not authenticated',
                code = 'ambiguous_account',
                accounts = [
                    spatio.models.account_choice.AccountChoice(
                        provider = '', 
                        account_id = '', 
                        account_name = '', )
                    ]
    ...
    def testCreateNote400Response(self):
        """Test CreateNote400Response"""
