...
class TestRevokeOtherSessionsResponse(unittest.TestCase):
    """RevokeOtherSessionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevokeOtherSessionsResponse:
        ...
        """
        model = RevokeOtherSessionsResponse()
        if include_optional:
    ...
    def testRevokeOtherSessionsResponse(self):
        """Test RevokeOtherSessionsResponse"""
