...
class TestMoveBlockRequest(unittest.TestCase):
    """MoveBlockRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveBlockRequest:
