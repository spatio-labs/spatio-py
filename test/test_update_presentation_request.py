...
class TestUpdatePresentationRequest(unittest.TestCase):
    """UpdatePresentationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePresentationRequest:
        ...
        """
        model = UpdatePresentationRequest()
        if include_optional:
    ...
    def testUpdatePresentationRequest(self):
        """Test UpdatePresentationRequest"""
