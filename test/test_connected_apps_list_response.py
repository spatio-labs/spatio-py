...
class TestConnectedAppsListResponse(unittest.TestCase):
    """ConnectedAppsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedAppsListResponse:
        ...
        """
        model = ConnectedAppsListResponse()
        if include_optional:
            return ConnectedAppsListResponse(
                items = [
                    spatio.models.connected_app_item.ConnectedAppItem(
                        client_id = '', 
                        client_name = '', 
                        logo_uri = '', 
                        client_uri = '', 
    ...
    def testConnectedAppsListResponse(self):
        """Test ConnectedAppsListResponse"""
