...
class TestUpdatePATRequest(unittest.TestCase):
    """UpdatePATRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePATRequest:
        ...
        """
        model = UpdatePATRequest()
        if include_optional:
            return UpdatePATRequest(
                name = '',
                description = ''
            )
        else:
