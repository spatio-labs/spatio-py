...
class TestConsumeAgentTaskResponse(unittest.TestCase):
    """ConsumeAgentTaskResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsumeAgentTaskResponse:
        ...
        """
        model = ConsumeAgentTaskResponse()
        if include_optional:
    ...
    def testConsumeAgentTaskResponse(self):
        """Test ConsumeAgentTaskResponse"""
