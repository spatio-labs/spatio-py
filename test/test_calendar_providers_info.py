...
class TestCalendarProvidersInfo(unittest.TestCase):
    """CalendarProvidersInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarProvidersInfo:
        ...
        """
        model = CalendarProvidersInfo()
        if include_optional:
            return CalendarProvidersInfo(
                providers = [
                    spatio.models.calendar_provider_info.CalendarProviderInfo(
                        id = '', 
                        name = '', 
                        display_name = '', 
                        description = '', 
    ...
    def testCalendarProvidersInfo(self):
        """Test CalendarProvidersInfo"""
