...
class TestExecuteChatActionResponse(unittest.TestCase):
    """ExecuteChatActionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteChatActionResponse:
        ...
        """
        model = ExecuteChatActionResponse()
        if include_optional:
    ...
    def testExecuteChatActionResponse(self):
        """Test ExecuteChatActionResponse"""
