...
class TestDMSetDraftRequest(unittest.TestCase):
    """DMSetDraftRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMSetDraftRequest:
        ...
        """
        model = DMSetDraftRequest()
        if include_optional:
            return DMSetDraftRequest(
                text = '',
                account_id = ''
            )
        else:
    ...
    def testDMSetDraftRequest(self):
        """Test DMSetDraftRequest"""
