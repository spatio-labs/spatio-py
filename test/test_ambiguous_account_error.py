...
class TestAmbiguousAccountError(unittest.TestCase):
    """AmbiguousAccountError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmbiguousAccountError:
    ...
    def testAmbiguousAccountError(self):
        """Test AmbiguousAccountError"""
