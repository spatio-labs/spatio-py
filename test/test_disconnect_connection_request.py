...
class TestDisconnectConnectionRequest(unittest.TestCase):
    """DisconnectConnectionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisconnectConnectionRequest:
        ...
        """
        model = DisconnectConnectionRequest()
        if include_optional:
    ...
    def testDisconnectConnectionRequest(self):
        """Test DisconnectConnectionRequest"""
