...
class TestGetEmailResponse(unittest.TestCase):
    """GetEmailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEmailResponse:
