...
class TestGetChatUserResponse(unittest.TestCase):
    """GetChatUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChatUserResponse:
        ...
        """
        model = GetChatUserResponse()
        if include_optional:
            return GetChatUserResponse(
                user = spatio.models.chat_user.ChatUser(
                    id = '', 
                    provider = '', 
                    account_id = '', 
                    name = '', 
    ...
    def testGetChatUserResponse(self):
        """Test GetChatUserResponse"""
