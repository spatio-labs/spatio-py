...
class TestWorkspaceInvitationListResponse(unittest.TestCase):
    """WorkspaceInvitationListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceInvitationListResponse:
        ...
        """
        model = WorkspaceInvitationListResponse()
        if include_optional:
            return WorkspaceInvitationListResponse(
                invitations = [
                    spatio.models.workspace_invitation.WorkspaceInvitation(
                        id = '', 
                        workspace_id = '', 
                        email = '', 
                        role = '', 
    ...
    def testWorkspaceInvitationListResponse(self):
        """Test WorkspaceInvitationListResponse"""
