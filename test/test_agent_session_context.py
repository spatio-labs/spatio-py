...
class TestAgentSessionContext(unittest.TestCase):
    """AgentSessionContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentSessionContext:
    ...
    def testAgentSessionContext(self):
        """Test AgentSessionContext"""
