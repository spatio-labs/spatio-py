...
class TestCommitChunkedUploadRequest(unittest.TestCase):
    """CommitChunkedUploadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommitChunkedUploadRequest:
        ...
        """
        model = CommitChunkedUploadRequest()
        if include_optional:
            return CommitChunkedUploadRequest(
                session_id = ''
            )
        else:
            return CommitChunkedUploadRequest(
    ...
    def testCommitChunkedUploadRequest(self):
        """Test CommitChunkedUploadRequest"""
