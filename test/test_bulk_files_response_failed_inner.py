...
class TestBulkFilesResponseFailedInner(unittest.TestCase):
    """BulkFilesResponseFailedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkFilesResponseFailedInner:
        ...
        """
        model = BulkFilesResponseFailedInner()
        if include_optional:
    ...
    def testBulkFilesResponseFailedInner(self):
        """Test BulkFilesResponseFailedInner"""
