...
class TestAgentMessageListResponse(unittest.TestCase):
    """AgentMessageListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgentMessageListResponse:
        ...
        if include_optional:
            return AgentMessageListResponse(
                messages = [
                    spatio.models.agent_message.AgentMessage(
                        id = '', 
                        conversation_id = '', 
                        role = '', 
                        content = '', 
    ...
    def testAgentMessageListResponse(self):
        """Test AgentMessageListResponse"""
