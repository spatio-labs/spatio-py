...
class TestUpdateContactCategoryRequest(unittest.TestCase):
    """UpdateContactCategoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateContactCategoryRequest:
        ...
        """
        model = UpdateContactCategoryRequest()
        if include_optional:
    ...
    def testUpdateContactCategoryRequest(self):
        """Test UpdateContactCategoryRequest"""
