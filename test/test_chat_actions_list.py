...
class TestChatActionsList(unittest.TestCase):
    """ChatActionsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatActionsList:
        ...
        """
        model = ChatActionsList()
        if include_optional:
            return ChatActionsList(
                actions = [
                    spatio.models.chat_action_definition.ChatActionDefinition(
                        id = '', 
                        name = '', 
                        description = '', 
                        platform = '', 
