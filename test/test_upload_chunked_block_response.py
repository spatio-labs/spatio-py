...
class TestUploadChunkedBlockResponse(unittest.TestCase):
    """UploadChunkedBlockResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadChunkedBlockResponse:
        ...
        """
        model = UploadChunkedBlockResponse()
        if include_optional:
    ...
    def testUploadChunkedBlockResponse(self):
        """Test UploadChunkedBlockResponse"""
