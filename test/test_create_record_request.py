...
class TestCreateRecordRequest(unittest.TestCase):
    """CreateRecordRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRecordRequest:
    ...
    def testCreateRecordRequest(self):
        """Test CreateRecordRequest"""
