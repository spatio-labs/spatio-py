...
class TestCreateAgentMessageRequest(unittest.TestCase):
    """CreateAgentMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAgentMessageRequest:
        ...
        """
        model = CreateAgentMessageRequest()
        if include_optional:
    ...
    def testCreateAgentMessageRequest(self):
        """Test CreateAgentMessageRequest"""
