...
class TestBulkMoveFilesRequest(unittest.TestCase):
    """BulkMoveFilesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkMoveFilesRequest:
    ...
    def testBulkMoveFilesRequest(self):
        """Test BulkMoveFilesRequest"""
