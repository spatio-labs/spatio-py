...
class TestSendChatMessageResponse(unittest.TestCase):
    """SendChatMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendChatMessageResponse:
    ...
    def testSendChatMessageResponse(self):
        """Test SendChatMessageResponse"""
