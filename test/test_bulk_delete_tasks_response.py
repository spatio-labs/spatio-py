...
class TestBulkDeleteTasksResponse(unittest.TestCase):
    """BulkDeleteTasksResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteTasksResponse:
    ...
    def testBulkDeleteTasksResponse(self):
        """Test BulkDeleteTasksResponse"""
