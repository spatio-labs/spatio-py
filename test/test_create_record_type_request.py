...
class TestCreateRecordTypeRequest(unittest.TestCase):
    """CreateRecordTypeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRecordTypeRequest:
    ...
    def testCreateRecordTypeRequest(self):
        """Test CreateRecordTypeRequest"""
