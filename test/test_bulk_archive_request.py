...
class TestBulkArchiveRequest(unittest.TestCase):
    """BulkArchiveRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkArchiveRequest:
    ...
    def testBulkArchiveRequest(self):
        """Test BulkArchiveRequest"""
