...
class TestDMForwardRequest(unittest.TestCase):
    """DMForwardRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMForwardRequest:
