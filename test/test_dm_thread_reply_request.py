...
class TestDMThreadReplyRequest(unittest.TestCase):
    """DMThreadReplyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DMThreadReplyRequest:
    ...
    def testDMThreadReplyRequest(self):
        """Test DMThreadReplyRequest"""
