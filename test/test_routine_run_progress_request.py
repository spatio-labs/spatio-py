...
class TestRoutineRunProgressRequest(unittest.TestCase):
    """RoutineRunProgressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutineRunProgressRequest:
        ...
        """
        model = RoutineRunProgressRequest()
        if include_optional:
    ...
    def testRoutineRunProgressRequest(self):
        """Test RoutineRunProgressRequest"""
