...
# **create_model**
> Dict[str, object] create_model(request_body)
...
with spatio.ApiClient(configuration) as api_client:
    ...
    api_instance = spatio.ModelsApi(api_client)
    request_body = None # Dict[str, object] | 

    try:
        # Register a model (admin-only).
        api_response = api_instance.create_model(request_body)
...
# **get_active_model**
> Dict[str, object] get_active_model(provider=provider)
...
with spatio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the active model for a given provider.
        api_response = api_instance.get_active_model(provider=provider)
        print("The response of ModelsApi->get_active_model:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ModelsApi->get_active_model: %s\n" % e)
```
...
# **set_active_model**
> Dict[str, object] set_active_model(id)
...
with spatio.ApiClient(configuration) as api_client:
    ...
    try:
        # Set a model as the active default for its provider (admin-only).
        api_response = api_instance.set_active_model(id)
        print("The response of ModelsApi->set_active_model:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ModelsApi->set_active_model: %s\n" % e)
```
...
# **update_model**
> Dict[str, object] update_model(id, request_body)
...
with spatio.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a model (admin-only).
        api_response = api_instance.update_model(id, request_body)
